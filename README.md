...
// Agent投票
system.vote('alpha', proposal.proposal.id, 0, '我推荐OpenAI'); // 投第一个选项
system.vote('beta', proposal.proposal.id, 1, '我推荐Anthropic'); // 投第二个选项
system.vote('gamma', proposal.proposal.id, 0); // 投第一个选项
...
// 查看统计
console.log(system.getConsensusStats());
```
